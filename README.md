...
An independently maintained **IntelliJ IDEA / JetBrains Git** experience for **VS Code** and **Cursor**. Includes Git graph visualization, IDEA-style commit panel with shelf and stash, branch management with context menus, cherry-pick, rebase, merge, and 3-way merge editor. Works like WebStorm, PyCharm, GoLand, and Rider's Git tooling.

> Independently maintained fork of [aotemj/jetbrains-git-graph](https://github.com/aotemj/jetbrains-git-graph), originally derived from [zhyc9de/jet-git](https://github.com/zhyc9de/jet-git). Upstream updates are merged or cherry-picked when they fit this project's direction.
...
![Branch Checkout](https://raw.githubusercontent.com/bbjyzzwwy/jetbrains-git-graph/main/images/checkout.gif)

### Commit Context Menu

Right-click any commit to copy hash, cherry-pick, checkout revision, reset, revert, create branch or tag.

![Commit Context Menu](https://raw.githubusercontent.com/bbjyzzwwy/jetbrains-git-graph/main/images/commit-context-menu.gif)
...
![3-Way Merge Editor](https://raw.githubusercontent.com/bbjyzzwwy/jetbrains-git-graph/main/images/three-way-merge.png)
...
![Conflict List](https://raw.githubusercontent.com/bbjyzzwwy/jetbrains-git-graph/main/images/conflicts-list.png)
...
Search for **"JetGit"** or install from this fork's release artifacts.

**From .vsix:**

1. Download the latest `.vsix` from [releases](https://github.com/bbjyzzwwy/jetbrains-git-graph/releases)
...
- Upstream fork: [aotemj/jetbrains-git-graph](https://github.com/aotemj/jetbrains-git-graph)
